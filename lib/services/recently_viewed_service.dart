...
import 'package:shopple/services/cloud_recently_viewed_service.dart';
...
class RecentlyViewedService {
  ...
  static Future<void> _ensureSnapshot(String productId) async {
    try {
      ...
      if (p == null) return;
      // Use shared price cache (prime + derive cheapest) instead of direct fetch.
  ...
  static Future<List<ProductWithPrices>> getWithPrices({int limit = 20}) async {
    ...
    // Prime cache for all ids; then read per-store maps from cache.
