...
class DashboardAddProjectSheet extends StatefulWidget {
  const DashboardAddProjectSheet({super.key});

  @override
  State<DashboardAddProjectSheet> createState() =>
      _DashboardAddProjectSheetState();
}

class _DashboardAddProjectSheetState extends State<DashboardAddProjectSheet> {
  late final TextEditingController projectNameController;
  late final ValueNotifier<int> settingsButtonTrigger;

  @override
  void initState() {
    super.initState();
    projectNameController = TextEditingController();
    settingsButtonTrigger = ValueNotifier(0);
  }
